    ...
    <div className="bg-blue-gray-700 lg:flex justify-between items-center">
        ...
        <div className="text-center lg:mb-10 p-8">
          ...
          >
            <span
              ...
              duration-300 ease-out transform -translate-x-2 -translate-y-2 bg-red-300 group-hover:translate-x-0 
      ...
      >
        ...
        <p className="p-4 lg:p-10 text-base sm:text-lg text-blue-gray-100 font-semibold">
          I am a hardworking and spearheaded individual aiming to secure a
          highly rewarding position as a Full Stack MERN (MongoDB, Express.js,
          React.js, Node.js) Developer, leveraging my profound expertise and
